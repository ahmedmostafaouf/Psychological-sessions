...
$("#file_export").DataTable({
    ...
    columns: [
        ...
        <div class="btn-group mr-1">
                    <button type="button" class="btn btn-light dropdown-toggle btn-sm mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti-settings"></i>
                    </button>
              <div class="dropdown-menu animated flipInY">
                <a class="dropdown-item" href="javascript:void(0)">show Student</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="javascript:void(0)">Separated link</a>
                </div>
        </div>
<a href="/dashboard/groups/${row.id}/edit" class="btn btn-info waves-effect waves-light btn-sm mr-1"  >
<span class="btn-label"><i class="fas fa-edit"></i></span>edit </a>
`;
            },
        },
    ],
