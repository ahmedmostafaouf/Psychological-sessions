                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="mt-4" action="{{route('fields.store')}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Field Name</label>
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="name Enter">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="short_description" id="exampleInputPassword1" placeholder="Short Desc"></textarea>
                                </div>
