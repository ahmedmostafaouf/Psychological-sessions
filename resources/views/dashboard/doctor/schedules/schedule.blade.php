                                        ...
                                        <td>
                                            <div class="button-group">
                                                <a href="#modaldemo9"
                                                   ...
                                                   data-date="{{$schedule->date}}" data-start_time="{{$schedule->start_time}}" data-end_time="{{$schedule->end_time}}"
                            ...
                            <form action="{{ route('schedules.store') }}" method="post">
                             ...
                             <input type="hidden" name="day">
                                <div class="form-group">
                                    <label for="wintType1">Doctor :</label>
                                    <select class="custom-select form-control required" id="wintType1"
                                            data-placeholder="Type to search cities" name="doctor_id"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local"  class="form-control" name="start_time" value="{{now()}}">
                                    @error("start_time")
                                    <span class="text-danger">{{$message}} </span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local"  class="form-control" name="end_time" value="">
                                    @error("end_time")
                                    <span class="text-danger">{{$message}} </span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-control-feedback"> Select your Average. </small>
                                    @error("average_consulting_time")
                                    <span class="text-danger">{{$message}} </span>
                                    @enderror
                                </div>
            ...
            <div class="modal" id="modaldemo9">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <form action="schedules/update" method="post">
                                {{ method_field('patch') }}
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="wintType1">Doctor :</label>
                                    <select class="custom-select form-control required" id="doctor_id"
                                            data-placeholder="Type to search cities" name="doctor_id"
                                            onclick="console.log($(this).val())">
            ...
            <div class="modal" id="delete">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <form action="schedules/destroy" method="post">
                               @method('delete')
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <label for="exampleFormControlTextarea1">Start Time</label>
                                        <input type="datetime-local"  class="form-control" name="start_time" id="start_time"  disabled>

                                    </div>
                                    <div class="col-6">
                                        <label for="exampleFormControlTextarea1">End Time</label>
                                        <input type="datetime-local"  class="form-control" name="end_time" id="end_time" disabled>
                                    </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
