                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$doctor->name}}" class="form-control required" id="wfirstName2"
                                                       name="name">
                                                @error("name")
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="{{$doctor->email}}" name="email" class="form-control required"
                                                       id="wphoneNumber2">
                                                @error("email")
                                                <span class="text-danger">{{$message}} </span>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" value="{{$doctor->phone}}" name="phone" class="form-control required" id="wdate2">
                                                @error("phone")
                                                <span class="text-danger">{{$message}} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1" name="gender" @if($doctor->gender==0) value="{{$doctor->gender}}" checked @else value="0"@endif class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio1">Female</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2" name="gender" @if($doctor->gender==1) value="{{$doctor->gender}}" checked @else value="1"@endif class="custom-control-input">
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="select2 js-programmatic-multiple form-control select2-hidden-accessible" id="programmatic-multiple" multiple="" style="width: 100%;height: 36px;" data-select2-id="programmatic-multiple" tabindex="-1" aria-hidden="true" name="lang[]">
                                                    <optgroup label="Language" data-select2-id="273">
                                                        ...
                                                        @if($doctor->lang)
                                                            ...
                                                            @endphp
                                                        @foreach($doctor->lang as $index => $lang)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="main_focus" required>{{$doctor->main_focus}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="specialties" required>{{$doctor->specialties}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control required" id="wintType1"
                                                    ...
                                                    @foreach($fields as $field)
                                                        <option @if($doctor->field_id==$field->id) selected @endif value="{{$field->id}}">{{$field->name}}</option>
                                                    @endforeach
                                                </select>
